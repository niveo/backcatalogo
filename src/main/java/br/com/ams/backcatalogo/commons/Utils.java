...
public class Utils {
	...
	public static File diretorioTemporarioEarquivo(String extencao) throws Exception {
		var dir = System.getProperty("sistema.diretorio.temporario") + File.separator + UUID.randomUUID().toString()
				+ File.separator;
	...
	public static File criarArquivoTemporario(String name) throws Exception {
		var file = new File(System.getProperty("sistema.diretorio.temporario"), name);
		System.out.println("Temporario: " + file);
		file.createNewFile();
		return file;
	}
